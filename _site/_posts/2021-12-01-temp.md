...
In the example above, I added validation on both the parent and the child DTO. It appears, however, that doing the same with DataAnnotations does not work.
