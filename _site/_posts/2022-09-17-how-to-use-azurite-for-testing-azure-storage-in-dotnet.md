...
In the post ["Working with Azure SDK for .NET"](/blog/2022/02/21/working-with-azure-sdk-for-dotnet.html) I made a point that connection strings should be a thing of the past. The `TokenCredential` should be the way forward (`dotnet add package Azure.Identity`).
