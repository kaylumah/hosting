...
## Can I use HTTPs in CICD pipelines?
...
The testing helpers have more to it than disabling SSL but are not present on NuGet. So naturally, I raised [an issue](https://github.com/Azure/azure-sdk-for-net/issues/30751) to the SDK team if they have any plans in that direction. Since the response was negative, I created a NuGet package inspired by what they did.