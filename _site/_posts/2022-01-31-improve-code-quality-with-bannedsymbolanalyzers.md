...
With the use of a TestSystemClock or a Moq, we can test our behaviour every day of the week. See, we are improving quality already. In a previous article, ["Adventures with Mock"](/blog/2021/04/11/an-approach-to-writing-mocks.html) you can read more about my preferred way of creating mocks.
