...
> **note**: on 2023-04-14 I published a revised version of this article which you can find here ["Generate C# client for OpenAPI - Revisited"](/2023/04/14/csharp-client-for-openapi-revistted.html) it compares an alternative to the way described in this article. Including an update to `net7.0`, but if you are looking specifically for configuring NSwag you can use this article for the general idea :)
