...
namespace Kaylumah.Ssg.Manager.Site.Service
{
    public class ObjectConversions
    {
        ...
        public static string PublishedTimeAgo(SiteMetaData siteMetaData, ArticlePublicationMetaData pagePublicationMetaData)
        {
            Debug.Assert(pagePublicationMetaData != null);
            ...
            DateTimeOffset publishedTime = pagePublicationMetaData.Published;
        ...
        public static string ReadingTime(ArticlePublicationMetaData pagePublicationMetaData)
        {
            TimeSpan duration = pagePublicationMetaData.Duration;
        ...
        public static IEnumerable<ArticlePublicationMetaData> ArticlesForTag(SiteMetaData site, string tag, int? take = null)
        {
            ArgumentNullException.ThrowIfNull(site);
            ArgumentNullException.ThrowIfNull(tag);

            bool tagExists = site.PagesByTags.TryGetValue(tag, out List<PageId>? idsForTag);
            IEnumerable<ArticlePublicationMetaData> result;
            if (tagExists && idsForTag != null)
            {
                IEnumerable<PageMetaData> resultForTag = site[idsForTag];
                IEnumerable<ArticlePublicationMetaData> asArticles = resultForTag.OfType<ArticlePublicationMetaData>();
            ...
            {
                result = Enumerable.Empty<ArticlePublicationMetaData>();
            }
