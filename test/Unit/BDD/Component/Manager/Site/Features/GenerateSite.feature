...
Feature: SiteManager GenerateSite
  ...
  Scenario: Generate website
    ...
    Given 'robots.txt' is an asset file with the following contents:
      """
      """
    Given 'data1.json' is a data file with the following contents:
      """
      {
        "id": "one"
      }
      """
    Given 'data2.csv' is a data file with the following contents:
      """
      id
      one
      """
    Given 'data3.yml' is a data file with the following contents:
      """
      id
      one
      """
